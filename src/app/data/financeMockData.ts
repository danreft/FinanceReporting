...
export const financeDeals = [
  ...
  {
    dealId: 'FR-1412',
    customer: 'Willow Creek Growers',
    contract: 'WCG-2026-014',
    source: 'Direct-Sourced',
    referralPartner: 'None',
    salesLead: 'Morgan Patel',
    partnerProgramManager: 'Direct',
    acres: 10600,
    contractValue: 318000,
    stage1Date: '2026-06-07',
    stage2Date: '',
    stage3Date: '',
    finalSales: 0,
    finalAcres: 0,
  ...
  },
  {
    ...
    contract: 'HPA-2026-019',
    source: 'RP-Sourced',
    referralPartner: 'Prairie Growth Advisors',
    partnerProgramManager: 'Sarah Keller',
    acres: 11450,
    contractValue: 344000,
    stage1Date: '2026-06-09',
    stage2Date: '',
    stage3Date: '',
    finalSales: 0,
    finalAcres: 0,
  ...
  {
    dealId: 'FR-1441',
    customer: 'Red Barn Cooperative',
    contract: 'RBC-2026-022',
    source: 'Direct-Sourced',
    referralPartner: 'None',
    salesLead: 'Jordan Miles',
    partnerProgramManager: 'Direct',
    acres: 9550,
    contractValue: 286000,
    stage1Date: '2026-06-13',
    stage2Date: '',
    stage3Date: '',
    finalSales: 0,
    finalAcres: 0,
  ...
  {
    dealId: 'FR-1458',
    customer: 'Golden Row Farms',
    contract: 'GRF-2026-010',
    source: 'RP-Sourced',
    referralPartner: 'Harvest Ridge Partners',
    partnerProgramManager: 'Marcus Lee',
    acres: 8800,
    contractValue: 264000,
    stage1Date: '2026-06-16',
    stage2Date: '',
    stage3Date: '',
    finalSales: 0,
    finalAcres: 0,
  ...
  {
    dealId: 'FR-1473',
    customer: 'Stonebridge Fields',
    contract: 'SBF-2026-015',
    source: 'Direct-Sourced',
    referralPartner: 'None',
    salesLead: 'Morgan Patel',
    partnerProgramManager: 'Direct',
    acres: 7700,
    contractValue: 231000,
    stage1Date: '2026-06-19',
    stage2Date: '',
    stage3Date: '',
    finalSales: 0,
    finalAcres: 0,
  ...
  {
    dealId: 'FR-1489',
    customer: 'Maple Ridge Agriculture',
    contract: 'MRA-2026-018',
    source: 'RP-Sourced',
    referralPartner: 'Dakota Land Network',
    partnerProgramManager: 'Nina Patel',
    acres: 6600,
    contractValue: 198000,
    stage1Date: '2026-06-21',
    stage2Date: '',
    stage3Date: '',
    finalSales: 0,
    finalAcres: 0,
  ...
  {
    dealId: 'FR-1506',
    customer: 'Silver Lake Produce',
    contract: 'SLP-2026-007',
    source: 'Direct-Sourced',
    referralPartner: 'None',
    salesLead: 'Avery Chen',
    partnerProgramManager: 'Direct',
...
export const monthlyFinance = months.map((month, index) => ({
  month,
  bookedSales: [555000, 336000, 1095000, 459000, 837000, 2604000][index],
...
export const incomeStatementRows = [
  ...
  ['Interest Expense', -5000, -4000, -28000, -26000],
  ['Income Tax Expense', -17000, -25000, -118000, -76000],
  ['Depreciation Expense', -18000, -16000, -104000, -92000],
  ['Amortization Expense', -7000, -6000, -43000, -36000],
