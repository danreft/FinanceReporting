...
export const powerBIImplementationMetadata: PowerBIImplementationMetadata[] = [
  ...
  {
    page: 'All Pages',
    element: 'Global slicer and filter pane',
    recommendedVisual: 'Native slicer plus Power BI filter pane fields',
    implementationApproach: 'Keep Reporting Period visible on the canvas and place secondary Department, Source, Customer, RP/RPM, account, and source-system filters in the Power BI filter pane.',
    requiredMeasures: [],
  ...
  },
  {
    ...
    requiredMeasures: ['Total Earned Revenue', 'Stage 1 Earned Revenue', 'Stage 2 Earned Revenue', 'Stage 3 Earned Revenue', 'Recognized Acres', 'Operational or CRM Earned Revenue', 'General-Ledger Revenue', 'Reconciliation Variance'],
  ...
  },
  {
    ...
    implementationApproach: 'Read-only analysis for Deals Moved Backward, Missing Stage Dates, General Ledger Mismatches, and Historical Period Changes. Reporting Period and Exception Type remain visible; Customer and Source System remain filter pane fields.',
